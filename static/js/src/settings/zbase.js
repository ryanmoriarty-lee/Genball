class Settings {
    constructor(root) {
        ...
        if(window.location.host === "app27.acapp.acwing.com.cn")
        {
            window.location.replace("https://www.genball.cn/")
        }
    ...
    <a href="http://beian.miit.gov.cn">粤ICP备2022004957号-1</a>sssssssssss
</div>
`);
