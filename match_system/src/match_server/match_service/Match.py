...
class Client(Iface):
    ...
    def add_player(self, score, uuid, username, sure_skin, player_x, player_y, channel_name):
        ...
        """
        self.send_add_player(score, uuid, username, sure_skin, player_x, player_y, channel_name)
        return self.recv_add_player()

    def send_add_player(self, score, uuid, username, sure_skin, player_x, player_y, channel_name):
        self._oprot.writeMessageBegin('add_player', TMessageType.CALL, self._seqid)
        args = add_player_args()
        args.score = score
        args.uuid = uuid
        args.username = username
        args.sure_skin = sure_skin
...
class Processor(Iface, TProcessor):
    ...
    def process_add_player(self, seqid, iprot, oprot):
        ...
        result = add_player_result()
        try:
            result.success = self._handler.add_player(args.score, args.uuid, args.username, args.sure_skin, args.player_x, args.player_y, args.channel_name)
...
class add_player_args(object):
    ...
    def __init__(self, score=None, uuid=None, username=None, sure_skin=None, player_x=None, player_y=None, channel_name=None,):
        self.score = score
        self.uuid = uuid
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I32:
                    self.sure_skin = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.DOUBLE:
                    self.player_x = iprot.readDouble()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.DOUBLE:
                    self.player_y = iprot.readDouble()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        ...
        if self.username is not None:
            ...
            oprot.writeFieldEnd()
        if self.sure_skin is not None:
            oprot.writeFieldBegin('sure_skin', TType.I32, 4)
            oprot.writeI32(self.sure_skin)
            oprot.writeFieldEnd()
        if self.player_x is not None:
            oprot.writeFieldBegin('player_x', TType.DOUBLE, 5)
            oprot.writeDouble(self.player_x)
            oprot.writeFieldEnd()
        if self.player_y is not None:
            oprot.writeFieldBegin('player_y', TType.DOUBLE, 6)
            oprot.writeDouble(self.player_y)
            oprot.writeFieldEnd()
...
add_player_args.thrift_spec = (
    ...
    (4, TType.I32, 'sure_skin', None, None, ),  # 4
    (5, TType.DOUBLE, 'player_x', None, None, ),  # 5
    (6, TType.DOUBLE, 'player_y', None, None, ),  # 6
